...
import org.tiqr.authenticator.qr.camera.open.OpenCameraManager;
...
public final class CameraManager {
    ...
    /**
     * A single preview frame will be returned to the handler supplied. The data will arrive as byte[] in the message.obj field, with width and height encoded
    ...
    /**
     * Calculates the framing rect which the UI should draw to show the user where to place the barcode. This target helps with alignment as well as forces the
